          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login" className="mt-6 space-y-4">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="tu@email.com" className="bg-zinc-900 border-zinc-700" />
              </div>
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/recuperar" className="text-xs text-purple-400 hover:text-purple-300">
                    ¿Olvidaste tu contraseña?
                  </Link>
                </div>
                <Input id="password" type="password" placeholder="••••••••" className="bg-zinc-900 border-zinc-700" />
              </div>
            ...
            <TabsContent value="register" className="mt-6 space-y-4">
              <div className="space-y-2">
                <Label htmlFor="register-name" className="text-sm text-zinc-400">
                  Nombre
                </Label>
                <Input id="register-name" type="text" placeholder="Tu nombre" className="bg-zinc-900 border-zinc-700" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="register-username" className="text-sm text-zinc-400">
                  Nombre de usuario
                </Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="register-email" className="text-sm text-zinc-400">
                  Correo Electrónico
                </Label>
                <Input
                  id="register-email"
              ...
              <div className="space-y-2">
                <Label htmlFor="register-password" className="text-sm text-zinc-400">
                  Contraseña
                </Label>
                <Input
